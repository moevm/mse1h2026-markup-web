...
Перед установкой необходимо иметь Docker и Python на устройстве.

| Компонент | Требования |
|---|---|
| Backend (Docker) | Python 3.12 — зафиксирован в Dockerfile, устанавливается автоматически |
| Frontend-server (локально) | Python **3.10** и выше |
